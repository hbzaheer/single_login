...
class res_users(osv.osv):
	...
	def clear_session(self, cr, user_id):
		...
		if not user_id:
			print "No User ID Passed II"
		self.write(cr, SUPERUSER_ID, user_id, {'session_id':'','expiration_date':'2010-02-01','logged_in':False})
	...
	def validate_sessions(self, cr, uid):
		ids = self.search(cr,SUPERUSER_ID,[('expiration_date','!=','2010-02-01')])
